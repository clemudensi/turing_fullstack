        ...
        remove: {
          rule: function(field, rule) {
            ...
            if (
              ...
              !$.isArray(validation[field].rules)
            ) {
              return;
            }
        ...
        event: {
          click: function(event) {
            ...
            if ($target.is(selector.input)) {
              module.verbose(
                "Using default check actions on initialized checkbox"
              );
              return;
            }
...
(function($, window, document, undefined) {
      ...
      module = {
        ...
        determine: {
          selectAction: function(text, value) {
            module.verbose("Determining actions", settings.action);
            if ($.isFunction(module.action[settings.action])) {
              module.verbose(
                "Triggering preset actions",
                settings.action,
                text,
                value
              );
        ...
        is: {
          ...
          alreadySetup: function() {
            return (
              $module.is("select") &&
              $module.parent(selector.dropdown).data(moduleNamespace) !==
                undefined &&
        ...
        can: {
          ...
          openRightward: function($subMenu) {
            ...
            isOffscreenRight =
              ...
              calculations.context.scrollLeft + calculations.context.width;
            if (isOffscreenRight) {
              module.verbose(
  ...
  $.fn.dropdown.settings = {
    ...
    on: "click", // what event should show menu actions on item selection
    action: "activate", // actions on item selection (nothing, activate, select, combo, hide, function(){})
    ...
    error: {
      action: "You called a dropdown actions that was not defined",
      alreadySetup:
      ...
      module = {
        ...
        bind: {
          ...
          scrollLock: function() {
            ...
            $dimmable
              .get(0)
              .addEventListener("touchmove", module.event.preventScroll, {
                passive: false
              });
          }
        },
        ...
        unbind: {
          scrollLock: function() {
            $dimmable
              .get(0)
              .removeEventListener("touchmove", module.event.preventScroll, {
                passive: false
              });
          }
        },
        ...
        event: {
          ...
          resize: function() {
            if (
              ...
              (module.is.animating() || module.is.active())
            ) {
        ...
        set: {
          ...
          modalOffset: function() {
            ...
            $module.css({
              marginTop:
                settings.centered && module.can.fit() ? -(height / 2) : 0,
              marginLeft: -(width / 2)
            });
      ...
      module = {
        ...
        set: {
          position: function(position, calculations) {
            ...
            if (
              ...
              module.debug("Popup target is hidden, no actions taken");
              return false;
            }
        ...
        should: {
          centerArrow: function(calculations) {
            return (
              !module.is.basic() &&
              calculations.target.width <= settings.arrowPixelsFromEdge * 2
            );
          }
        },
        ...
        is: {
          ...
          visible: function() {
            return (
              $popup !== undefined && $popup.hasClass(className.popupVisible)
            );
          },
          dropdown: function() {
        ...
        event: {
          ...
          blur: function(event) {
            ...
            if (module.resultsClicked) {
              module.debug("Determining if user actions caused search to close");
              $module.one(
              ...
              module.debug(
                "Input blurred without user actions, closing results"
              );
              callback();
            }
          },
            ...
            click: function(event) {
              ...
              if ($.isFunction(settings.onSelect)) {
                if (
                  ...
                  module.debug(
                    "Custom onSelect callback cancelled default select actions"
                  );
        ...
        addResults: function(html) {
          if ($.isFunction(settings.onResultsAdd)) {
            if (settings.onResultsAdd.call($results, html) === false) {
              module.debug("onResultsAdd callback cancelled default actions");
              return false;
            }
          }
          if (html) {
...
(function($, window, document, undefined) {
          ...
          containerSize: function() {
            ...
            if (tagName === "HTML" || tagName == "body") {
              ...
              if (
                ...
                module.debug(
                  "Context has padding, specifying exact height for containers",
            ...
            if (module.is.initialPosition()) {
              if (scroll.top >= context.bottom) {
                ...
                if (
                  ...
                  module.debug(
                    "Initial element position is bottom of containers"
                  );
                  module.bindBottom();
                } else {
              ...
              // currently fixed bottom
                ...
                if (scroll.bottom - element.height <= element.top) {
                  module.debug(
                    "Bottom fixed rail has reached top of containers"
                  );
                  module.setInitialPosition();
                }
                // bottom edge
                  ...
                  module.debug(
                    "Bottom fixed rail has reached bottom of containers"
                  );
                  module.bindBottom();
                }
                // scroll element if larger than screen
  ...
  $.fn.sticky.settings = {
    ...
    // will only set containers height if difference between context and containers is larger than this number
    jitter: 5,
    ...
    error: {
      ...
      elementSize:
        "Sticky element is larger than its containers, cannot create sticky."
    },
...
(function($, window, document, undefined) {
      ...
      module = {
        ...
        get: {
          ...
          templatedURL: function(action) {
            ...
            if (action) {
              module.debug("Looking up url for actions", action, settings.api);
              ...
              module.debug(
                "No url or actions specified, defaulting to form actions",
                url
              );
            }
            return url;
  ...
  $.api.settings = {
    ...
    error: {
      ...
      method: "The method you called is not defined",
      missingAction: "API actions used but no url was defined",
      missingSerialize:
